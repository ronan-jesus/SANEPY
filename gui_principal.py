...
class Gui_principal ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.salvar = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Salvar Projeto", u"Salva o projeto atual", None )

		self.abrir = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Abrir Projeto", u"Abre janela de busca de arquivo", None )

		self.toolbar.AddSeparator()

		self.gerenciaModE = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Definir Materiais", u"Abre janela de gerenciamento de materiais", None )

		self.gerenciaSecoes_I = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Definir Seções", u"Abre janela de gerenciamento de seções", None )

		self.toolbar.AddSeparator()

		self.mostraNormal = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Mostrar Esforços Normais", u"Altera visualização da estrutura para visualização dos esforços normais nas barras", None )

		self.mostraCortante = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Mostrar Esforços Cortantes", u"Altera visualização da estrutura para visualização dos esforços cortantes nas barras", None )

		self.mostraFletor = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Mostrar Momentos Fletores", u"Altera visualização da estrutura para visualização dos esforços dos momentos fletores nas barras", None )

		self.mostraTorcor = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Mostrar Momentos Torsores", u"Altera visualização da estrutura para visualização dos momentos torsores nas barras", None )

		self.toolbar.AddSeparator()

		self.pan = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Alterar Mouse para PAN", u"Altera o enquadramento da tela para ser arrastado com o mouse", None )

		self.zoomAll = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Dar ZoomAll", u"Enquadra toda a estrutura na porção de tela visivel", None )

		self.orbit = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Alterar Mouse para Orbit", u"Altera o enquadramento da tela para girar com o arraste do mouse", None )

		self.toolbar.AddSeparator()

		self.seta_calcular = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Calcular Estrutura", u"Faz a verificação e cálculo da estrutura em análise", None )
		...
		self.btn_vista_esquerda = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Visualizar Estrutura a Esquerda", u"Altera camera para visualizar a estrutura na parte esquerda", None )

		self.m_tool15 = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Visualizar Estrutura a Direita", u"Altera camera para visualizar a estrutura na parte direita", None )

		self.m_tool16 = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Visualizar Estrutura de Frente", u"Altera camera para visualizar a estrutura na parte da frente", None )

		self.m_tool17 = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Visualizar Estrutura de Trás", u"Altera camera para visualizar a estrutura na parte de trás", None )

		self.m_tool18 = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Visualizar de cima", u"Altera camera para visualizar a estrutura na parte de cima", None )

		self.m_tool19 = self.toolbar.AddTool( wx.ID_ANY, u"tool", wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"visualizar de baixo", u"Altera camera para visualizar a estrutura na parte de baixo", None )
