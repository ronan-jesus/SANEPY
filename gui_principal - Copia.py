...
class Gui_principal ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.menu_opcoes = wx.Menu()
		self.item_opcoes_habilitar_visualizacao_elementos = wx.MenuItem( self.menu_opcoes, ID_MENU_OPCOES_HABILITAR_ELEMENTOS, u"Habilitar/Desabilitar Elementos", wx.EmptyString, wx.ITEM_NORMAL )
		self.menu_opcoes.Append( self.item_opcoes_habilitar_visualizacao_elementos )

		self.item_opcoes_unidades = wx.MenuItem( self.menu_opcoes, ID_MENU_OPCOES_UNIDADES, u"Unidades e Formatos", wx.EmptyString, wx.ITEM_NORMAL )
		self.menu_opcoes.Append( self.item_opcoes_unidades )

		self.m_menubar2.Append( self.menu_opcoes, u"Opções" )
