...
#        pv1 = PV_Retangular([102978.0, 105606.0, 0], 55.00, 2.42)
#        pv2 = PV_Retangular([101318.0, 99396.0, 0], 56.34, 4.08)
#        pv3 = PV_Retangular([100057.0, 99319.1, 0], 55.98, 3.783)
#        pv4 = PV_Retangular([97521.1, 100012.0, 0], 54.35, 2.679)
#        pv5 = PV_Retangular([95576.7, 100574.0, 0], 52.34, 2.287)
#        pv6 = PV_Retangular([93012.5, 101240.0, 0], 49.17, 1.4)
#        pv7 = PV_Retangular([91501.9, 100481, 0], 49.00, 1.4)        
##
#        self.AdicionaPV(pv1)
#        self.AdicionaPV(pv2)
#        self.AdicionaPV(pv3)
...
##         
##         
#        trecho1 = Tubo([pv1,pv2], nome="1-1")
#        trecho1.SetDiametroTrecho(0.3)
#        trecho1.TaxaInicial = 0.0
#        trecho1.TaxaFinal = 0.0
#        trecho1.TaxaInfiltracao = 0.0        
#        
#        trecho2 = Tubo([pv2,pv3], nome="1-1")
#        trecho2.SetDiametroTrecho(0.4)
#        trecho2.TaxaInicial = 0.0
#        trecho2.TaxaFinal = 0.0
#        trecho2.TaxaInfiltracao = 0.0 
#        
#        trecho3 = Tubo([pv3,pv4], nome="1-1")
#        trecho3.SetDiametroTrecho(0.4)
#        trecho3.TaxaInicial = 0.0
#        trecho3.TaxaFinal = 0.0
#        trecho3.TaxaInfiltracao = 0.0 
#        
#        trecho4 = Tubo([pv4,pv5], nome="1-1")
#        trecho4.SetDiametroTrecho(0.4)
#        trecho4.TaxaInicial = 0.0
#        trecho4.TaxaFinal = 0.0
#        trecho4.TaxaInfiltracao = 0.0 
#        
#        trecho5 = Tubo([pv5,pv6], nome="1-1")
#        trecho5.SetDiametroTrecho(0.4)
#        trecho5.TaxaInicial = 0.0
#        trecho5.TaxaFinal = 0.0
#        trecho5.TaxaInfiltracao = 0.0 
#        
#        trecho6 = Tubo([pv6,pv7], nome="1-1")
#        trecho6.SetDiametroTrecho(0.4)
#        trecho6.TaxaInicial = 0.0
#        trecho6.TaxaFinal = 0.0
#        trecho6.TaxaInfiltracao = 0.0 
##        
#        self.AdicionaTubo(trecho1)
#        self.AdicionaTubo(trecho2)
#        self.AdicionaTubo(trecho3)
